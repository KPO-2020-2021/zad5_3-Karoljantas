...
class  Gora: public bryla
{
   ...
   public:
    Gora(){};
    Gora(  Vector<3> pkt0, double wysokosc, double szerokosc, double dlugosc, std::string nazwa);
/*!
 ...
 */
 ...
 point[4][0]=pkt0[0]+szerokosc/2;
 point[4][1]=pkt0[1]+wysokosc/2;
  point[4][2]+=dlugosc;

 point[5][0]=pkt0[0]+szerokosc/2;
 point[5][1]=pkt0[1]+wysokosc/2;
 point[5][2]+=dlugosc;

 point[6][0]=pkt0[0]+szerokosc/2;
 point[6][1]=pkt0[1]+wysokosc/2;
  point[6][2]+=dlugosc;

 point[7][0]=pkt0[0]+szerokosc/2;
 point[7][1]=pkt0[1]+wysokosc/2;
 point[7][2]+=dlugosc;
 }
 ...
 */
std::ostream &operator <<(std::ostream &out,const  Gora &tmp )
{
    for(int i=0;i< 8;i++)
    {
    out<<tmp[i]<<std::endl;
